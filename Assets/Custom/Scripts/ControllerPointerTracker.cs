...
public class ControllerPointerTracker : MonoBehaviour
{
    ...
    public void ungrabLeft()
    {
        ...
        addRecord(grabbedObjectLeft.name, startGrabLeft, endGrabLeft, startGrabPosLeft.x, endGrabPosLeft.x,
    ...
    public void ungrabRight()
    {
        ...
        addRecord(grabbedObjectRight.name, startGrabRight, endGrabRight, startGrabPosRight.x, endGrabPosRight.x,
